100.times do
	...
	Vote.create(user_id: rand(1..80), voteable_id: rand(1..80) , voteable_type: ["Post", "Comment"].sample  )
	Post.create(user_id: rand(1..80), title: Faker::Lorem.word, content: Faker::Lorem.sentence)
	Comment.create(user_id: rand(1..80), content: Faker::Lorem.sentence,  commentable_id: rand(1..80) , commentable_type: ["Post", "Votes"].sample)
